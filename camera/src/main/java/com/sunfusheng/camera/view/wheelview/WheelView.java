package com.sunfusheng.camera.view.wheelview;
...
import com.sunfusheng.camera.R;
...
public class WheelView extends View {
  ...
  public WheelView(Context context, AttributeSet attrs) {
    ...
    int itemWidth = a.getDimensionPixelOffset(R.styleable.WheelView_wheelItemWidth,
        $dp(R.dimen.wheel_item_width));
    int itemHeight = a.getDimensionPixelOffset(R.styleable.WheelView_wheelItemHeight,
        $dp(R.dimen.wheel_item_height));
    int textSize =
        a.getDimensionPixelSize(R.styleable.WheelView_wheelTextSize, $sp(R.dimen.wheel_text_size));
    int textColor =
        a.getColor(R.styleable.WheelView_wheelTextColor, $color(R.color.wheel_text_color));
    int selectedTextColor = a.getColor(R.styleable.WheelView_wheelSelectedTextColor,
        $color(R.color.wheel_selected_text_color));
    int dividerColor =
        a.getColor(R.styleable.WheelView_wheelDividerColor, $color(R.color.wheel_divider_color));
    int highlightColor = a.getColor(R.styleable.WheelView_wheelHighlightColor,
    ...
    mDividerPaint.setStrokeWidth(
        getResources().getDimensionPixelOffset(R.dimen.wheel_divider_height));
